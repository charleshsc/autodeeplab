...
def obtain_retrain_autodeeplab_args():
    ...
    parser.add_argument('--net_arch', default=None, type=str,help='corresponding to network_path_space')
    parser.add_argument('--cell_arch', default=None, type=str,help='corresponding to genotype')
    parser.add_argument('--net_path',default=None, type = str,help = 'corresponding to network_path')
    ...
    parser.add_argument('--saver',type=str,default='retrain_para')
